...
mod test_common {
    ...
    pub fn test_deco_data<'a>() -> Vec<(u8, &'a str, &'a str)> {
        vec![
            ...
            (11, "кгс/с_м^2", "98066.50000000 [кг^1 * м^-1 * с^-2]"),
            (12, "ат", "98066.50000000 [кг^1 * м^-1 * с^-2]"),
        ]
    }
...
mod test_parser_unit {
    ...
    use super::test_common::check_unit_parse;
...
mod test_parser_expr {
    ...
    use super::test_common::{check_convert_parse, check_fraction_parse};
...
mod test_folder {
    ...
    use super::test_common::init_units;
...
mod test_interpreter {
    ...
    use super::test_common::{test_conv_data, test_deco_data, EPS};
